...
public enum ErrorCode {
    ...
    PLACE_NONPOSITIVE_CAPACITY("PLACE-002", "최대 인원은 음수나 0이 될 수 없습니다.", HttpStatus.BAD_REQUEST),
    ...
    TIMESLOT_NEGATIVE_CAPACITY("TIMESLT-004", "최대 인원은 음수가 될 수 없습니다.", HttpStatus.BAD_REQUEST),
