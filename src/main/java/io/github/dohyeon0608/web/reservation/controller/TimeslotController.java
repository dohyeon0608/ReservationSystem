...
public class TimeslotController {
    ...
    @ApiErrorCodes({ ErrorCode.TIMESLOT_DUPLICATED_TIME, ErrorCode.TIMESLOT_INVALID_TIME, ErrorCode.TIMESLOT_NEGATIVE_CAPACITY })
    ...
    @ApiErrorCodes({ ErrorCode.TIMESLOT_NOT_FOUND })
